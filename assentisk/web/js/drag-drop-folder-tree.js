		...
		initTree : function()
		{
			...
			if(this.deleteAllowed || this.renameAllowed || this.addAllowed){
				try{
					...
					if(this.addAllowed)menuModel.addItem(3,'Add','','',false,'JSTreeObj.addItem');
					menuModel.init();	
					...
					if(this.deleteAllowed)menuModelDeleteOnly.addItem(5,'Delete','','',false,'JSTreeObj.deleteItem');
					menuModelDeleteOnly.init();	
					
					var menuModelAddOnly = new DHTMLGoodies_menuModel();
					if(this.addAllowed)menuModelAddOnly.addItem(6,'Add','','',false,'JSTreeObj.addItem');
