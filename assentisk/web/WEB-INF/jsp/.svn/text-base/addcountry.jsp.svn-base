...
<%@include file="leftpanel.jsp" %>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.addCountryHeader}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
         <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.addCountryHeader}"/></li>
        </ol>
      </div>
    </div>
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="countryname"  id="countryname" class="form-control" ng-model="countryname" ng-init="countryname=''" maxlength="250">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
