...
<%@include file="leftpanel.jsp" %>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.AddDepartment_header}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
         <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.AddDepartment_header}"/></li>
        </ol>
      </div>
    </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.Department_Location}"/><font color="red">*</font></label>
  					<select class="form-control" ng-model="branchid" ng-init='branchid = ""'>
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="departmentname"  id="departmentname" class="form-control" ng-model="departmentname" ng-init='departmentname = ""' maxlength="100">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
                ...
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<textarea rows="4" cols="10" name="departmentdesc" style="display:inline-block;" class="form-control" ng-model="departmentdesc" maxlength="250" ng-init="departmentdesc=''"></textarea>
											<script>
