...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.editauditplanHeader}"/></h2>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body" ng-app="auditapp" ng-controller="editAuditController">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="auditname"  id="auditname" class="form-control" value="<c:out value="${auditName}"/>" maxlength="250">
                    <input type="hidden" name="auditid"  id="auditid" class="form-control" ng-model="auditid" ng-init="auditid='<c:out value="${auditid}"/>'" maxlength="250">
                    <input type="hidden" name="resetauditname"  id="resetauditname" class="form-control" value="<c:out value="${auditName}"/>" maxlength="250">
              		...
              		<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
																...
																<input type="text" id="locationdata"  name="locationdata" class="form-control" value="<c:out value="${location}"/>">
														       <input type="hidden" name="resetlocationdata"  id="resetlocationdata" class="form-control" ng-model="resetlocationdata" value="<c:out value="${location}"/>" />														
            ...
            <div class="panel-footer">
              ...
              <a href="#" onclick="cancel();"><button class="btn btn-primary" type="button" title="<c:out value="${sessionScope.button_cancel}"/>"><c:out value="${sessionScope.button_cancel}"/></button></a>
