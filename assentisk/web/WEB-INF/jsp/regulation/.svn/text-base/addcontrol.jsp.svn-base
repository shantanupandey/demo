...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.addcontrol_page_header}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
         <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.addcontrol_page_header}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body" ng-app="controlapp" ng-controller="addcontrolController">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="controlid"  id="controlid" class="form-control" ng-model="controlid" ng-init='controlid = ""' maxlength="25">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<textarea rows="4" cols="10" name="risk" style="display:inline-block;" class="form-control" ng-model="risk" maxlength="250" ng-init="risk=''"></textarea>
											<script>
              ...
              <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<textarea rows="4" cols="10" name="controlobjective" style="display:inline-block;" class="form-control" ng-model="controlobjective" maxlength="250" ng-init="controlobjective=''"></textarea>
											<script>
              ...
              <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<textarea rows="4" cols="10" name="controldesc" style="display:inline-block;" class="form-control" ng-model="controldesc" maxlength="250" ng-init="controldesc=''"></textarea>
											<script>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.Control_category}"/><font color="red">*</font></label>
					      ...
					      <input type="text" name="controlCatdata"  id="controlCatdata" class="form-control" ng-model="controlCatdata" ng-init='controlCatdata = ""'  onblur="return checkControl(this.value);">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.assets_buisness_process}"/><font color="red">*</font></label>
					      ...
					      <input type="text" name="businessProcess"  id="businessProcess" class="form-control" ng-model="businessProcess" ng-init='businessProcess = ""' onblur="return checkbusiness(this.value);">
            ...
            <div class="panel-footer">
              ...
              <a href="controls.reg.htm"><button class="btn btn-primary" type="button" title="<c:out value="${sessionScope.cancel}"/>"><c:out value="${sessionScope.cancel}"/></button></a>
