...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.edittest_page_header}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
         <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.edittest_page_header}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body" ng-app="testapp" ng-controller="edittestController">
            <form ng-submit="saveData()">        
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="controlid">
													...
													<c:choose>
															<c:when test="${list.Control_ID == controlid}">
																<option value="<c:out value="${list.Control_ID}"/>" selected>
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                   <input type="hidden" name="testid" class="form-control" id="testid" ng-model="testid" maxlength="250" ng-init="testid='<c:out value="${testid}"/>'">
                  
                    <label class="control-label"><c:out value="${sessionScope.addtest_page_teststep}"/></label>
                   
					<textarea rows="4" cols="10" name="editor" id="editor" style="display:inline-block;" class="form-control" ng-model="teststep" maxlength="250" ng-init="teststep='<c:out value="${Test_Steps}"/>'"></textarea>
            ...
            <div class="panel-footer">
              ...
              <a href="test.reg.htm"><button class="btn btn-primary" type="button" title="<c:out value="${sessionScope.cancel}"/>"><c:out value="${sessionScope.cancel}"/></button></a>
