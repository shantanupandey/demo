...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.add_category}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
          <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.add_category}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body" ng-app="categoryapp" ng-controller="addCategoryController">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="categoryname" id="categoryname" class="form-control" ng-model="categoryname" maxlength="250" ng-init="categoryname=''">
