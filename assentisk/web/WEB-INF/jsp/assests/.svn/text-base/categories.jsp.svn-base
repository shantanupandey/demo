...
var rowID;
 var sortingOrder = 'ID';
function categoriesController($scope,$http,$filter) {
    ...
    $scope.pagedItems = [];
    $scope.currentPage = 0;
  	$http.get('categoryList.assets.htm').
    success(function(data, status, headers, config) {

    $scope.items = data.categoriesBeans;
...
categoriesController.$inject = ['$scope','$http','$filter'];  
...
{	
	...
	if(action == 'yes')
	{
		...
		$.get("deletecategory.assets.htm?id="+rowID,function(data,status){ location.reload(true);});
	}
	else
	{
	...
	<body class="<c:out value="${sessionScope.bodyClass}"></c:out>">
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<c:out value="${sessionScope.Categories_Header}"/>
				</h2>
			...
			<div class="contentpanel">
				<div ng-app="" ng-controller="categoriesController">
					<c:if test="${sessionScope.add_mod_33=='1'}">
						<a class="btn btn-success" href="addcategory.assets.htm" title="<c:out value="${sessionScope.tooltip_add}"/>"
				 ...
				 <div class="content demo-x">
					<table class="table table-striped table-condensed table-hover"
						...
						<thead>
							<tr>
								<th class="cname" style="min-width:820px;max-width:820px;">
									
									<a ng-click="sort_by('cname')"><i class="icon-sort"></i><c:out value="${sessionScope.category_name}"/>
									</a>
								</th>
<!--								<th class="IsActive">-->
<!--									IsActive&nbsp;-->
...
<!---->
<!--								</td>-->
								<td class="center" style="min-width:250px;max-width:250px;word-wrap:break-word;">
									<c:if test="${sessionScope.edit_mod_33=='1'}">
										<a class="btn btn-info"
											href="editcategory.assets.htm?categoryid={{item.ID}}"
											title="<c:out value="${sessionScope.tooltip_edit}"/>"><i class="fa fa-edit "></i>
										</a>
									</c:if>
									<c:if test="${sessionScope.delete_mod_33=='1'}">
