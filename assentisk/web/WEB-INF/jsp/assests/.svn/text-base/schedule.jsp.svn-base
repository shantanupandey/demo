...
line-height:12px;
  ...
  <script type="text/javascript">
   ...
   {  
		...
		var employeedata = document.getElementById("responsiblehead").value;
   		amcname=jQuery.trim(amcname);
		document.getElementById("amcname").value=amcname;	
		...
		else if(amcname=='' || amcname == undefined){
			$('#assetAlert').show();
			$('#assetAlert').delay(1500).fadeOut('slow');	
			return false;
		}
		else if(filter.test(amcname) == true){	
        		$('#validamcname').show();
				$('#validamcname').delay(1500).fadeOut('slow');
				document.getElementById("amcname").focus();	
				return false;
	    }

		else if(scheduledata=='' || scheduledata == undefined ){
			$('#scheduledataAlert').show();
			$('#scheduledataAlert').delay(1500).fadeOut('slow');	
			return false;
		}
   		return true;
   }
  ...
  <script>
  	...
  	function saveScheduler(){
			...
			var assetid= document.getElementById("assetiddata").value;
			...
			document.getElementById("yearmonthWeeksection12").value=yearmonthWeeksection;
								...
								$.get("addScheduler.assets.htm?assetid=" + assetid + "&startTime="
										...
										+endoccurence+"&endRadio="+endRadio+"&schedulerID="+schedulerID+
...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.schedule_header}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
          <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.schedule_header}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <form method="post" action="saveschedule.assets.htm"  enctype="multipart/form-data" onsubmit="return validate();">       
                     <input type="hidden" name="tasktype" class="form-control" id="tasktype" maxlength="250" value="system">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.schedule_contractName}"/><font color="red">*</font></label>                    
                    ...
                    <input type="hidden" name="assetiddata" class="form-control" id="assetiddata" maxlength="250" value="<c:out value="${param.id}"/>">
                    <input type="text" name="amcname" class="form-control" id="amcname" maxlength="250" value="<c:out value="${AMC_CName}"/>">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.schedule_vendore}"/></label>
                    <select class="form-control" id="vendor" name="vendor">
                    <option value="select">-- Select Vendor --</option>
                    	<c:forEach var="list" items="${vendorList}">
                    		
                    		<c:choose>
                    			
                    			<c:when test="${VendorID == list.id}"><option value="<c:out value="${list.id}"/>" selected="selected"><c:out value="${list.VendorName}"/></option></c:when>
                    			<c:otherwise><option value="<c:out value="${list.id}"/>"><c:out value="${list.VendorName}"/></option></c:otherwise>
              ...
              <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.schedule_res_person}"/></label>
              ...
              <input type="hidden" name="scheduledataval" class="form-control" id="scheduledataval" maxlength="250" value="<c:out value="${schdulerderdata}"/>">
               ...
               <div class="row">               
                    ...
                    <label class="control-label"><div id="schedulerContent" style="color:black;font-size: 12px;"><c:out value="${schdulerderdata}"/></div></label>
                    <a id="opener" href="#"  cursor="pointer" data-toggle="modal"  onclick="openScheduler();" title="<c:out value="${sessionScope.scheduler}"/>"><b><c:out value="${sessionScope.scheduler}"/></b></a>
...
<script src="js/left-menu.js"></script>
   ...
   <div  id="startAlert" class="error2">
    ...
    <div  id="scheduledataAlert" class="error2">
            <span >   <c:out value="${sessionScope.Add_schedulerAlert}"/>  </span>
    </div>
    <div  id="validamcname" class="error2">
            <span >   <c:out value="${sessionScope.validamcname}"/>  </span>
    </div>
