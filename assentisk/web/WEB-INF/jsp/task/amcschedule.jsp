      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
           ...
           <input type="hidden" name="tasktype" class="form-control" id="tasktype" maxlength="250" value="amc">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="assetiddata" class="form-control" id="assetiddata" maxlength="250" value="<c:out value="${assetID}"/>">
