		...
		if(scheduledata=='' || scheduledata == undefined ){
		 ...
		 if(fromdate=='' || fromdate == undefined){
			...
			return false;
       		  ...
       		  $.ajax("checktask.assets.htm?taskname="+taskname+"&fromdate="+fromdate+"&todate="+todate+"&employeedata="+employeedata, {
       			 async: false,
  	...
  	function saveScheduler(){
			...
			document.getElementById("yearmonthWeeksection12").value=yearmonthWeeksection;
								...
								$.get("addScheduler.assets.htm?startTime="
										...
										+endoccurence+"&endRadio="+endRadio+"&dailyRadio="+dailyRadio+"&dailyrecur="+dailyrecur+
...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.task_add_schedule_header}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label"><c:out value="${sessionScope.DashBoard_YouAreHere}"/>:</span>
        <ol class="breadcrumb">
          <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.task_add_schedule_header}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <form method="post" action="addTaskschedule.assets.htm"  enctype="multipart/form-data" >       
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="fromdate" class="form-control" id="fromdate" value="" autocomplete="off">
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="todate" class="form-control" id="todate" value="" autocomplete="off">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="taskname" class="form-control" id="taskname" maxlength="250" value="">
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
			...
			<input type="hidden" name="startTime12"  id="startTime12"/>
			 			<input type="hidden" name="endTime12"  id="endTime12"/>
						<input type="hidden" name="duration12"  id="duration12"/>
						<input type="hidden" name="oRadio12"  id="oRadio12"/>
						<input type="hidden" name="recur12"  id="recur12"/>
						<input type="hidden" name="weekid12"  id="weekid12"/>
						<input type="hidden" name="dateStart12"  id="dateStart12"/>
						<input type="hidden" name="endDate12"  id="endDate12"/>
						<input type="hidden" name="endoccurence12"  id="endoccurence12"/>
						<input type="hidden" name="endRadio12"  id="endRadio12"/>
						<input type="hidden" name="schedulerID12"  id="schedulerID12"/>
						<input type="hidden" name="dailyRadio12"  id="dailyRadio12"/>
						<input type="hidden" name="dailyrecur12"  id="dailyrecur12"/>
						
						<input type="hidden" name="monthlyRadio12"  id="monthlyRadio12"/>
						<input type="hidden" name="daymonthlyrecur12"  id="daymonthlyrecur12"/>
						<input type="hidden" name="monthlyrecurmon12"  id="monthlyrecurmon12"/>
						<input type="hidden" name="monthsection12"  id="monthsection12"/>
						
						
						<input type="hidden" name="monthWeeksection12"  id="monthWeeksection12"/>
						<input type="hidden" name="daymonthlyyearrecur12"  id="daymonthlyyearrecur12"/>
						<input type="hidden" name="yearmonthlyRadio12"  id="yearmonthlyRadio12"/>
						<input type="hidden" name="yearsection12"  id="yearsection12"/>
						
						<input type="hidden" name="ONyearrecur12"  id="ONyearrecur12"/>
						<input type="hidden" name="yearmonthsection12"  id="yearmonthsection12"/>
						<input type="hidden" name="yearmonthWeeksection12"  id="yearmonthWeeksection12"/>	
    ...
    <div class="modal-content">
     ...
     <div class="bottomdiv">
							<div class="bottomLeft">
									<c:out value="${sessionScope.Scheduler_start}"/>&nbsp;&nbsp;&nbsp;:<font color="red"> *</font>&nbsp;<input type="text" name="dateStart" id="dateStart"  style="width:130px;"  value="">
									</br>
							...
							<div class="bottomRight">
									<table class="ptd">
											<tr>
												...
												<td colspan=3>
														<input type="radio" name="endRadio" id="endRadiodefault" value="1" checked>&nbsp;<c:out value="${sessionScope.Scheduler_NoEndDate}"/><br>
												</td>
											</tr>
											<tr>
												<td>
														<input type="radio" name="endRadio" id="endRadiodefault" value="2" >&nbsp;<c:out value="${sessionScope.Scheduler_Endafter}"/>:<br>
												</td>
												<td >
											...
											<tr>
												<td>
														<input type="radio" name="endRadio" value="3" >&nbsp;<c:out value="${sessionScope.Scheduler_EndBy}"/>&nbsp;&nbsp;&nbsp;:<font color="red"> *</font><br>
												</td>
												<td colspan=2>
														&nbsp;<input type="text" name="endDate" id="endDate" style="width:130px;" value="">
												</td>
					...
					<div  class="centerdiv">
							...
							<input type="radio" name="pattern" style="margin-bottom:3px;"  value="1" id="patterndefault" checked><c:out value="${sessionScope.SchedulerDiv_daily}"/><br>
							<input type="radio" name="pattern" style="margin-bottom:3px;"  value="2" ><c:out value="${sessionScope.SchedulerDiv_weekly}"/><br>
							<input type="radio" name="pattern" style="margin-bottom:3px;"  value="3" ><c:out value="${sessionScope.SchedulerDiv_monthly}"/><br>
							<input type="radio" name="pattern" style="margin-bottom:3px;"  value="4" ><c:out value="${sessionScope.SchedulerDiv_Yearly}"/><br>
							</div>
							<div  class="rightdiv" id="dailyID" style="display:none">
								...
								<table class="ptd">
									...
									<tr>
										<td>
											<input type="radio" name="dailyRadio" id="dailyRadiodefault" value="1" checked><c:out value="${sessionScope.SchedulerDiv_Every}"/><br>
										</td>
										<td>
									
													
													<input type="text" name="dailyrecur" id="dailyrecur"
												style="width: 35px;" value="1"  onblur="dailyRecur(this.value);">
									...
									<tr>
										<td>
											<input type="radio" name="dailyRadio" value="2" ><c:out value="${sessionScope.SchedulerDiv_EveryWeekDay}"/><br>
							...
							<div  class="rightdiv" id="weekendID" style="display:none">
								...
								<table class="ptd">
									...
									<tr>
										<td>
											<input type="checkbox" name="weekid" value="1" >
											<c:out value="${sessionScope.Scheduler_sunday}"/>

										</td>
										<td>
											<input type="checkbox" name="weekid" value="2"  >
											<c:out value="${sessionScope.Scheduler_monday}"/>
										</td>
										<td>
											<input type="checkbox" name="weekid" value="3">
												<c:out value="${sessionScope.Scheduler_tuesday}"/>
										</td>
										<td>
											<input type="checkbox" name="weekid" value="4" >
											<c:out value="${sessionScope.Scheduler_wednesday}"/>
										</td>
									</tr>
									<tr>
										<td>
										 <input type="checkbox" name="weekid" value="5" >
											<c:out value="${sessionScope.Scheduler_Thrusday}"/>

										</td>
										<td>
											<input type="checkbox" name="weekid" value="6" >
											<c:out value="${sessionScope.Scheduler_friday}"/>
										</td>
										<td>
											<input type="checkbox" name="weekid" value="7" >
							...
							<div  class="rightdiv" id="monthlyID" style="display:none">
								...
								<table class="monthpdt" >
									...
									<tr>
										<td>
											<input type="radio" name="monthlyRadio" id="monthlyRadiodefault" value="1" >	<c:out value="${sessionScope.Scheduler_day}"/><br>
										</td>
										<td>
										...
										<td>
													...
													<input type="text" name="monthlyrecur" id="monthlyrecur"
														style="width: 30px;"  value="1" onblur="monthlyrecurfun(this.value);">
									...
									<tr>
										<td>
											<input type="radio" name="monthlyRadio" value="2" ><c:out value="${sessionScope.Scheduler_the}"/><br>
										</td>
										<td>
							...
							<div  class="rightdiv" id="yearlyID" style="display:none">
								...
								<table class="monthpdt" >
									...
									<tr>
										<td>
											<input type="radio" name="yearmonthlyRadio" id="yearmonthlyRadiodefault" value="1" ><c:out value="${sessionScope.Scheduler_on}"/>:<br>
										</td>
										<td>
...
<script src="js/left-menu.js"></script>
			...
			<div id="submitSucess" class="success">
			          <span style="color: white"><c:out value="${sessionScope.Vendore_Successfully_Alert}"/> </span>
			 </div>
			 
			  <div  id="assetAlert" class="error2">
			          <span style="color: white"> <c:out value="${sessionScope.Scheduler_Amc_alert}"/></span>
			 </div>
			 
			 <div  id="vendorAlert" class="error2">
			         <span style="color: white"><c:out value="${sessionScope.Scheduler_vendorName_alert}"/></span>
			 </div>
			 
			  <div  id="fromdateAlert" class="error2">
			         <span style="color: white"><c:out value="${sessionScope.Scheduler_fromDate_alert}"/></span>
			 </div>

  			<div  id="todateAlert" class="error2">
			          <span style="color: white"><c:out value="${sessionScope.Scheduler_toDate_alert}"/></span>
			 </div>
			 <div  id="businessProcessAlert" class="error2">
			         <span style="color: white"><c:out value="${sessionScope.Scheduler_buisProc_alert}"/></span>
			 </div>
			 
			 <div  id="employeeAlert" class="error2">
			        <span style="color: white"> <c:out value="${sessionScope.Scheduler_empName_alert}"/> </span>
			 </div>
			 
			 <div id="wrongAdd" class="error2">
	         <span style="color: white"><c:out value="${sessionScope.Scheduler_loc_alert}"/>  </span>
			 </div>
			  <div id="startTimealert " class="error2">
			          <span style="color: white"><c:out value="${sessionScope.Scheduler_strttime_alert}"/> </span>
			 </div>
			
		<div id="dateStartalert " class="error2">
            <span style="color: white"><c:out value="${sessionScope.Select_Start_DateAlert}"/> </span>
    </div>
    <div id="endDateAlert " class="error2">
            <span style="color: white"> <c:out value="${sessionScope.Select_End_DateAlert}"/> </span>
    </div>
    <div  id="duration " class="error2">
    
             <span style="color: white"> <c:out value="${sessionScope.Enter_DurationAlert}"/> </span>
    </div>
     <div  id="divlocationAlert" class="error2">
             <span style="color: white"> <c:out value="${sessionScope.Add_Location_NameAlert}"/></span>
    </div>
   
     
    <div  id="divtestAlert" class="error2">
             <span style="color: white"> <c:out value="${sessionScope.Add_DivisionAlert}"/></span>
    </div>
    
    
     <div  id="divRespAlert" class="error2">
             <span style="color: white"><c:out value="${sessionScope.Enter_Responsible_HeadAlert}"/></span>
    </div>
    <div  id="alertSuc" class="success">
            <span style="color: white"> <c:out value="${sessionScope.Submit_Successfully}"/></span>
    </div>
       
   <div  id="startAlert" class="error2">
            <span style="color: white"><c:out value="${sessionScope.Enter_Start_DateAlert}"/></span>
    </div>
    <div  id="timestartdiff" class="error2">
            <span style="color: white">  <c:out value="${sessionScope.Select_Start_timeAlert}"/> </span>
    </div>
    ...
    <div  id="scheduledataAlert" class="error2">
           <span style="color: white">  <c:out value="${sessionScope.Add_schedulerAlert}"/>  </span>
    </div>
    <div  id="validtaskname" class="error2">
          <span style="color: white">  <c:out value="${sessionScope.validtaskname}"/>  </span>
    </div>
     <div  id="tasknameAlert" class="error2">
           <span style="color: white">  <c:out value="${sessionScope.tasknameAlert}"/>  </span>
    </div>
    <div  id="zeroalert" class="error2">
            <span style="color: white">   <c:out value="${sessionScope.alert_zero}"/>  </span>
    </div>
    <div  id="task_responsible_alert" class="error2">
            <span style="color: white">  <c:out value="${sessionScope.task_responsible_alert}"/>  </span>
    </div>
    
    <div  id="assetAlreadyAlert" class="error2">
            <span style="color: white">  <c:out value="${sessionScope.assetAlreadyAlert}"/>  </span>
    </div>
        <div  id="responsible_head_message" class="error2">
            <span style="color: white">  <c:out value="${sessionScope.responsible_head_message}"/>  </span>
    </div>
