...
<%@include file="/WEB-INF/jsp/leftpanel.jsp"%>
    ...
    <div class="pageheader">
      <h2><c:out value="${sessionScope.editticketCat}"/></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
         <li><a href="dashboard.login.htm">Assentisk</a></li>
          <li class="active"><c:out value="${sessionScope.editticketCat}"/></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body" ng-app="vendorCatApp" ng-controller="editticket">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="control-label"><c:out value="${sessionScope.ticket_cat_name}"/><font color="red">*</font></label>
                     <input type="hidden" name="catid" class="form-control" ng-model="catid"  ng-init="catid='<c:out value="${ticketCatID}"/>'"  maxlength="250" >
                    <input type="text" name="catname" id="catname"  class="form-control" ng-model="catname" ng-init='catname="<c:out value="${ticketCatName}"/>"' maxlength="250" >
                    <input type="hidden" name="catnamecheck" class="form-control" ng-model="catnamecheck" ng-init='catnamecheck="<c:out value="${ticketCatName}"/>"' maxlength="250" >
                  </div>
                </div><!-- col-sm-6 -->
              </div><!-- row -->
            ...
            <input type="hidden" name="resetcat" id="resetcat"  class="form-control" ng-model="resetcat" ng-init='resetcat="<c:out value="${ticketCatName}"/>"' maxlength="250" >
          </div>
        </div>
