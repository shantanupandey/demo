      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <form method="post" action="updateSAMCschedule.assets.htm"  enctype="multipart/form-data" onsubmit="return validate();">       
               ...
               <div class="row">               
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="fromdate" class="form-control" id="fromdate" value="<c:out value="${FromDate}"/>">
               ...
               <div class="row">               
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="dateSchedule" class="form-control" id="dateSchedule" value="<c:out value="${dateSchedule}"/>">
