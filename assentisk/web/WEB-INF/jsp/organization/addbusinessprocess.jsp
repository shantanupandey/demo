...
<body class="<c:out value="${sessionScope.bodyClass}"></c:out>">
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<c:out value="${sessionScope.addBuisnessHeader}"/>
				</h2>
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body" ng-app="businessprocessapp"
								ng-controller="addBusinessProcessController">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" name="businessprocessname" id="businessprocessname" class="form-control"
													ng-model="businessprocessname" ng-init="businessprocessname=''" maxlength="100">
										...
										<div class="col-sm-6">
											<div class="form-group">
																...
																<input type="text"  id="testdata" name="testdata"
																	class="form-control" ng-model="testdata" ng-init="testdata=''">
